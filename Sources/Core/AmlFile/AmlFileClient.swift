...
public struct LiveAmlFileClient: AmlFileClient {
...
extension Application {
	...
	private struct AmlFileClientKey: StorageKey {
		typealias Value = AmlFileClient
	}

        /// Accessor to the configured aml.file client.
        public var amlFileClient: AmlFileClient {
                get {
...
extension Request {
        ...
        public var amlFileClient: AmlFileClient {
                self.application.amlFileClient
        }
}
